...
data-image-src="{{ asset('frontend/img/header-bg2.png') }}">
...
<div class="container">
  ...
  <div class="active-cat-carusel">
      ...
      <div class="item single-cat">
        ...
        <img style="border-radius: 8px" src="{{ asset('upload/post/'.$p->image) }}" alt="" />
        </a>
      ...
      <div class="row d-flex justify-content-center">
          ...
          <div class="row justify-content-center">
            @foreach ($posts as $p )
                ...
                <div class="item single-cat col-lg-4 col-sm-4 mb-3">
                    <a href="{{ url('post/'.$p->slug) }}">
                    ...
                    <div class="detail">
                        <a href="{{ url('post/'.$p->id) }}"><h4 class="pb-20">{{ $p->title }}</h4></a>
