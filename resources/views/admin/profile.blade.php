        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mx-auto d-block">
                    <img  class=" mx-auto d-block" src="{{asset('upload/user/'.$user->image)}}" alt="Card image cap" width="200px">
                    ...
                    <div class="default-tab">
                        ...
                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            <div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                <form action="{{url('admin/profile/update')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="userid" name="user_id" placeholder="Text" class="form-control" value="{{$user->user_id}}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <form action="{{url('admin/profile/changePassword')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    @method('PUT')
                                <div class="row form-group">
